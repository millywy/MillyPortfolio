      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        <FadeIn>
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed" style={{color: 'hsl(var(--muted-foreground))'}}>
            ...
            <div className="glass-card rounded-2xl p-8 max-w-2xl mx-auto my-12 border-2 border-dashed border-primary/30">
              <div className="text-primary/60 text-center">
                ...
                <p className="text-lg font-medium" style={{color: 'hsl(var(--foreground))'}}>3D Interactive Scene</p>
                <p className="text-sm mt-2" style={{color: 'hsl(var(--muted-foreground))'}}>Future: Floating islands/brain objects with Spline</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
              ...
              <a 
                href="/cv.pdf"
                className="glass-card hover:bg-card/50 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 inline-block"
